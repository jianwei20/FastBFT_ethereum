...
// For bft validator commit locally 
type BFTValidatorBlock struct {
	Block 		 *Block
	PeerId 		 string
} 

func NewBFTValidatorBlock(block *Block, peerId string) (*BFTValidatorBlock, error) {
	fmt.Println("-------in NewBFTValidatorBlock-------")
	return &BFTValidatorBlock{
		Block:  block,
		PeerId: peerId,
	}, nil
}
